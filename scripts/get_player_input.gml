...
//if(GameController.input_enabled){
    ...
    attack_button_held_down = keyboard_check(ord('A'));
    attack_button_pressed = keyboard_check_pressed(ord('A'));
    attack_button_released = keyboard_check_released(ord('A'));
    special_button_held_down = keyboard_check(ord('S'));
    special_button_pressed = keyboard_check_pressed(ord('S'));
    special_button_released = keyboard_check_released(ord('S'));
    ...
    if(gamepad_is_connected(gp_id)) {
        ...
        attack_button_held_down = gamepad_button_check(gp_id, gp_face3) && !gamepad_button_check(gp_id, gp_shoulderrb);
        attack_button_pressed = gamepad_button_check_pressed(gp_id, gp_face3) && !gamepad_button_check(gp_id, gp_shoulderrb);
        attack_button_released = gamepad_button_check_released(gp_id, gp_face3) && !gamepad_button_check(gp_id, gp_shoulderrb);
        special_button_held_down = gamepad_button_check(gp_id, gp_face2) && !gamepad_button_check(gp_id, gp_shoulderrb);
        special_button_pressed = gamepad_button_check_pressed(gp_id, gp_face2) && !gamepad_button_check(gp_id, gp_shoulderrb);
        special_button_released = gamepad_button_check_released(gp_id, gp_face2) && !gamepad_button_check(gp_id, gp_shoulderrb);
